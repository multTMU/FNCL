...
namespace Multiplicity
{
    ...
    {
        public static bool FileExistsAndNotEmpty(string pulseFile)
        {
        ...
        public static class BinaryFileHelper
        {
            ...
            private static FnclPulse GetPulse(byte[] buffer)
            {
                ...
                double timeStamp = BitConverter.ToUInt64(subBuff.ToArray(), ARRAY_START);
            ...
            public static void AddBinaryPulses(Pulses<FnclPulse> pulses)
            {
                List<FnclPulse> pulseList = GetPulses(pulses.PulseFile);
                pulses.AddPulses(pulseList);
            }
        ...
        public static class FlatFileHelper
        {
            ...
            public static string GetFileLine<TPulse>(TPulse pulse) where TPulse : IPulse
            {
                return pulse.GetDetector().ToString() + " " + pulse.GetTime().ToString();
            }
